...
suí = Postposition("suí", definition="from, of, since, away from, for, in favor of, more than")
koty = Postposition("koty", definition="versus, in the direction of, towards")
obaké = Postposition("obaké", definition="(t) in front of, before, facing, in the presence of, in front of")
enondé = Postposition("enondé", definition="(t) in front of, before, facing, in the presence of")
...
ri = Postposition("ri", definition="for, because of, in order to, during, about, regarding, concerning")
