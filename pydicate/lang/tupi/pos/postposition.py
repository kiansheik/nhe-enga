...
esé = Postposition("esé", definition="(t); about, in regard to, because of, for, in order to")
...
pupé = Postposition("pupé", definition="inside, within, in, into, inside of, using, with")
amo = Simulational()
