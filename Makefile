...
lint:
	...
	cp pydicate/dist/pydicate-* gramatica/docs/src/.vuepress/public/pylibs/
	cp pydicate/dist/pydicate-* ../tupi-annotation-suite/public/
	cp tupi/dist/tupi-* ../tupi-annotation-suite/public/
