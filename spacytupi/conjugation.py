...
def conjugation_table( verbo_tupi ):
    ...
    if verbo_tupi.type == 0:
        df_table = subject_intr_df +' '+pref_intr_df + verbo_tupi.verbete
    elif verbo_tupi.type == 1:
        df_table = subject_tr_df +' '+ pref_tr_df +verbo_tupi.verbete+' '+suf_tr_df
        df_table = df_table.replace(' '+verbo_tupi.verbete+' ', "--//--")
    elif verbo_tupi.type == 2:
        df_table = subject_tr_df +' '+ pref_tr_plr_df + verbo_tupi.verbete+' '+suf_tr_df
        df_table = df_table.replace(' '+verbo_tupi.verbete+' ', "--//--")
    elif verbo_tupi.type == 3:
        df_table = second_class_prefix_df + verbo_tupi.verbete
    elif verbo_tupi.type == 4:
